...
function [P,F,a,obj_values]= MultiViews_classifier(X, Y, lambda1,lambda2, eta, mu1, mu_Max, max_iter, tol)
...
Q = P;  % Initialize Q = P
F = ones(N, V)/V; %Initialize F, ensure that the line sum of F is 1
