## code of SAVWMVC for "Multi-view Classification via Sample-level Adaptive View Weighting".

      To run our code, please run the "demo.m" function. The parametres used in the experiments
 for datasets are listed in variable "Pr".
